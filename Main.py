    ...
    def run(self):
        ...
        while self._running:
            ...
            if len(self._balls) > 0:
                self._x.append(self._balls[0].body.position.x)
                self._y.append(self._balls[0].body.position.y)
                self._vx.append(self._balls[0].body.velocity.x)
                self._vy.append(self._balls[0].body.velocity.y)
